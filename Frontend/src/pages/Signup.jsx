      ...
      <div  className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div  className="hidden lg:block bg-primaryColor rounded-l-lg">
          <figure className="rounded-l-lg">
            <img src={signupImg} alt="hello" className="w-full rounded-lg"/>
        ...
        <div className="rounded-l-lg lg:pl-16 py-10">
          ...
          <div className="mb-5 flex items-center justify-betweeen">
            <label
            ...
            <label
             className="text-headingColor font-bold text-[16px] leading-7 ml-20"
             >
              Gender:
              <select name="gender" 
          ...
          <div className="mb-5 flex items-center gap-3">
            ...
            <div className="relative w-[130px] h-[50px]">
              ...
              />
              <label htmlFor="custom file" className="absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem]
